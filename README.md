...
[![Status: MVP Development](https://img.shields.io/badge/Status-MVP%20Development-orange)](https://github.com/昊尘002/openblock)
...
```bash
# 从源码构建
git clone https://github.com/昊尘002/openblock.git
cd openblock
npm install
npm run dev
```
...
- GitHub Issues: [问题反馈](https://github.com/昊尘002/openblock/issues)
- 讨论区: [GitHub Discussions](https://github.com/昊尘002/openblock/discussions)
